...
import AAMO from "../components/accessARMO";
...
class Repuestouploader extends Component {
  ...
  render () {
    ...
    const Comprobador = this.state.Access?  <AAMO /> :   <div style={{marginTop:"10vh"}}>Sin acceso a esta área</div>
