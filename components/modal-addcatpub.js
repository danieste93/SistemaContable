...
class CatpubAdd extends Component {
   state={
...
<div id="mainaddc"className="maincontacto" >
            ...
            <p> Agregar Nueva Categoria de Publicación</p>
...
export default connect(mapStateToProps, null)(CatpubAdd);
