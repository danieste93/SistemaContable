...
class ListVenta extends Component {
    ...
    state={
        Precio_Venta:this.props.datos.Precio_Venta.toFixed(2),
        ...
        Cantidad:this.props.datos.CantidadImpresion,
        unidadProducto:1,
        pesoProducto:1,
...
` }  </style>
    ...
    this.props.sendCantidad({value:e.target.value,
...
<div className="Articid">{item.Eqid} </div>
           ...
           <div className="Artic100Fpago">
            {this.ComprobadorTipoArt(cantidadErr)}
             ...
             <div className="Artic100Fpago">
                <Animate show={true}>
         <span className='FlexCenter'> $ <input type="number" name="Precio_Venta" className={` inputCustom `}placeholder="0.00" value={this.state.Precio_Venta} onChange={this.handleChangePrecio }/></span>
         </Animate>
