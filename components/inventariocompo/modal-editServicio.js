...
import { updateArt} from '../../reduxstore/actions/regcont';
...
class Contacto extends Component {
  ...
  state={
    ...
    Vendedor:{  Nombre:this.props.state.userReducer.update.usuario.user.Usuario,
     ...
     TituloServ:this.props.data.Titulo,
     Timereq:this.props.data.TiempoReq.tiempo,
     Iva:this.props.data.Iva,
     TimeMesuare:this.props.data.TiempoReq.Formato,   
     PrecioServ:this.props.data.Precio_Venta,
     PrecioServAlt:this.props.data.Precio_Alt,
      ...
      if(this.state.urlImg.length > 0){
        imgpreview = this.state.urlImg.map((imagen, i)=>{
          return(
            ...
            <button className=" btn btn-danger botonedit" onClick={()=>{this.deleteImg(imagen)}}>
