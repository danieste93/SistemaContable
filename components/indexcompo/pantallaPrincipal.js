            ...
            {showRedirectModal && (
                <div style={{position:'fixed',top:0,left:0,width:'100vw',height:'100vh',background:'rgba(24,24,24,0.18)',zIndex:99999,display:'flex',alignItems:'center',justifyContent:'center'}}>
                    <div style={{background:'#fff',borderRadius:18,boxShadow:'0 2px 18px #6366f188',padding:'38px 28px',maxWidth:340,width:'90vw',textAlign:'center'}}>
                        <img src="/static/logo1.png" alt="Logo" style={{width:60,marginBottom:18,borderRadius:12,boxShadow:'0 2px 8px #6366f144'}} />
                        <h2 style={{color:'#6366f1',fontWeight:700,fontSize:'1.18em',marginBottom:12}}>¡Bienvenido!</h2>
                        <p style={{fontSize:'1.08em',color:'#232323',marginBottom:10}}>
                            En unos segundos serás dirigido a tu panel de administración.<br/>
                            <b style={{color:'#6366f1'}}>Redirigiendo en {countdown}…</b>
                        </p>
                    </div>
                </div>
            )}
