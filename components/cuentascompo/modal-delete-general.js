      ...
      DeleteElement=()=>{
        ...
        let reg ={
          User:{DBname:this.props.state.userReducer.update.usuario.user.DBname},         
            item:this.props.itemTodelete
        }
        let lol = JSON.stringify(reg)
        var url = this.props.mensajeDelete.url;
        ...
        if(response.message=="error al registrar"){
          ...
          this.props.sendSuccess(response)
          this.Onsalida();
...
<div className="maincontacto" id="maindeletecaut" >
            ...
            <p> {this.props.mensajeDelete.mensaje}  <span style={{fontWeight:"bolder"}}> </span>  </p>
