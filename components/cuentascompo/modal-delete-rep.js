...
import {deleteRep} from "../../reduxstore/actions/regcont"
  ...
  state={
    ...
    componentDidMount(){
      ...
      DeleteReg=(reg)=>{
        ...
        let lol = JSON.stringify(dataSend)
        var url = '/cuentas/deleterepeticion';
        ...
        this.Onsalida()
        let repdata = response.repe
        this.props.dispatch(deleteRep({repdata}))
      }
...
<div className="maincontacto" id="maindeletecaut" >
            ...
            <p> Seguro quieres eliminar esta Repetición </p>
