...
import { updateCat} from "../../reduxstore/actions/regcont"
...
class Contacto extends Component {
   state={
    ...
    componentDidMount(){
     ...
     this.setState({
      subArr : this.props.catToEdit.subCategoria,
      tipocat:this.props.catToEdit.tipocat,
      nombreCat:this.props.catToEdit.nombreCat,
      Nombrebuscar:this.props.catToEdit.nombreCat,
      urlIcono:this.props.catToEdit.urlIcono,
      selectIcon:this.props.catToEdit.selectIcon
     })
      setTimeout(function(){ 

        document.getElementById('mainedditcat').classList.add("entradaaddc")
      ...
      handleChangeGeneral=(e)=>{
        ...
        .then(response => {
          ...
          if(response.message=="error al registrar"){
            ...
            const cat = response.cat
      this.props.dispatch(updateCat({cat}))
        ...
        Onsalida=()=>{
          document.getElementById('mainedditcat').classList.remove("entradaaddc")
          setTimeout(()=>{ 
    ...
    render () {
      ...
      generadorsub = this.state.subArr.map((sub,i)=>{
...
<div id="mainedditcat"className="maincontacto" >
...
<div className="contPrin">
        ...
        <div className="cDc1x">
              <p style={{fontWeight:"bolder"}}>  Tipo de cuenta  </p>
            
              </div>
              <div id =""className="cDc2" >
        
              <select disabled={true}className="selectin" value={this.state.tipocat}  onChange={this.handlerepChange} > 
        ...
        <div className="cDc1">
              ...
              <TextField
               error={this.state.err1}
                fullWidth name="nombreCat" value={this.state.nombreCat} onChange={this.handleChangeGeneral} id="standard-basic" label="" />
    ...
    value={this.state.newcat}
       ...
       <div className="borderok">
        <i className="material-icons " onClick={this.AgregarNuevaSub}>  done</i>
        </div>
        </div>
