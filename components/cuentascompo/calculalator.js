  ...
  render() {
    ...
    return (
      <PointTarget onPoint={onPress}>
        <button className={`butoncalcu calculator-key ${className}`} {...props}/>
      </PointTarget>
    )
  }
}
...
class Calculator extends React.Component {
  ...
  clearLastChar() {
    ...
    this.props.inputNumber( displayValue.substring(0, displayValue.length - 1) || '0')
  }
  ...
  toggleSign() {
    ...
    this.props.inputNumber(String(newValue))
  }
  ...
  inputPercent() {
    ...
    this.props.inputNumber(String(newValue.toFixed(fixedDigits.length + 2)))
  }
  ...
  inputDot() {
    ...
    if (!(/\./).test(displayValue)) {
      ...
      this.props.inputNumber(displayValue + '.0') 
    }
  }
  ...
  inputDigit(digit) {
    ...
    if (waitingForOperand) {
      ...
      this.props.inputNumber(String(digit))
    } else {
      this.setState({
        displayValue: displayValue === '0' ? String(digit) : displayValue + digit
      })
      this.props.inputNumber( displayValue === '0' ? String(digit) : displayValue + digit)
  ...
  performOperation(nextOperator) {    
    ...
    if (value == null) {
      ...
      this.setState({
        ...
        displayValue: String(newValue.toFixed(2))
      })
      this.props.inputNumber(String(newValue.toFixed(2))) 
