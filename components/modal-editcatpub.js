...
class Catpub extends Component {
   state={
   
   loading:false,
    subArr : this.props.data.subCategoria,
    archivos:[],
    tipocat:"Publicacion",
    newcat:"",
    nombreCat:this.props.data.nombreCat,
    errSub:false,
    urlIcono:this.props.data.urlIcono,
    selectIcon:false,
...
console.log(this.props.data.nombreCat)
      ...
      uploadimages=(vals)=>{
        ...
        for(let i=0; i<this.state.archivos.length;i++){
          console.log(this.state.archivos[i])
          console.log([i])
       ...
       console.log(this.state.archivos.length)
        if(stateactualizado.length == this.state.archivos.length){
          vals.imagenes = stateactualizado
          let datos = {
            valores:vals,
        ...
        comprobador=()=>{
          ...
          if(this.state.nombreCat != ""){
            ...
            if(this.state.archivos.length > 0){
              ...
              this.uploadimages(vals)
            }else{
              if(this.state.urlImg.length == 0){
                vals.imagenes = ['/blog/publicidadgeneral.jpg']
              }else{
                vals.imagenes = this.state.urlImg
              }
...
<div id="mainaddc"className="maincontacto" >
            ...
            <p> Editar Categoria de Publicación</p>
...
export default connect(mapStateToProps, null)(Catpub);
