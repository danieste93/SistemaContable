...
class Contacto extends Component {
  ...
  state={
    ...
    const Alert=(props)=> {
      ...
      let prods = this.props.item.map(tem=>(<div >
        <span className='enfacisText'>{tem.Product}</span> ha caducado el &nbsp;
        <span className='enfacisText'> {tem.Caduca.FechaCaducidad}</span>
      </div>) ) 
...
<div className="maincontacto" id="maindeletecaut" >
            ...
            <div className="headercontact">
              ...
              <div className="tituloventa ">
                <p className='tituloArt'>Combo caducado</p>
                <div className='ContText'>
            <p className=''> El producto o los productos           
              </p>
<div>
  {prods}
</div>
<p>seguro los quieres vender?</p>
                   </div>
                   </div>
             </div>
